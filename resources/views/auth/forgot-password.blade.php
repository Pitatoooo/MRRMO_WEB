    ...
    <div class="register-container">
        <div class="register-form-wrapper">
            ...
            <div class="forgot-password-info">
                <p>Forgot your password? Enter your email address, the admin secret password, and your new password to reset it.</p>
            </div>
            ...
            <form method="POST" action="{{ route('password.email') }}" class="login-form">
                ...
                <div class="form-group">
                    <label for="secret_password">
                        <i class="fas fa-key"></i> Admin Secret Password
                    </label>
                    <input id="secret_password" type="password" name="secret_password" required 
