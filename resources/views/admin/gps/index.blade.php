...
// // ✅ AUTO-PIN LOGIC: Intelligent Address Resolution
...
//     // 1. EXTRACT COORDINATES (from Params or Location String)
...
//     // 2. PINNING & ADDRESS FILLING LOGIC
//     if (targetLat !== null && targetLng !== null) {
//         const addrField = document.getElementById('case-address');
//         const coordString = `${targetLat.toFixed(6)}, ${targetLng.toFixed(6)}`;

//         // A. IMMEDIATE FEEDBACK: Fill box with what we have (Text or Coords)
//         if (addrField) {
...
//         // B. MAP OPERATIONS (Delayed slightly to ensure load)
//         setTimeout(() => {
//             // Remove old pins
...
//             // C. ADDRESS REFINEMENT (The Magic Part)
//             // If the box currently holds coordinates (numbers), try to find the real name!
//             if (addrField) {
//                 const currentVal = addrField.value;
//                 // Regex: Looks like "14.2, 121.2"
//                 const isJustCoords = /^(-?\d+(\.\d+)?)[,\s]+(-?\d+(\.\d+)?)$/.test(currentVal.trim());
                
//                 if (isJustCoords) {
//                     console.log('📍 Coordinates detected in text box. Fetching street name...');
//                     // This will overwrite the numbers with "Bayacal Street..." once loaded
